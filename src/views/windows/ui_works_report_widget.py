...
class Ui_WorkReportsWidget(object):
    def setupUi(self, WorkReportsWidget):
        if not WorkReportsWidget.objectName():
            WorkReportsWidget.setObjectName("WorkReportsWidget")
    ...
    def retranslateUi(self, WorkReportsWidget):
        WorkReportsWidget.setWindowTitle(
            QCoreApplication.translate("WorkReportsWidget", "Form", None)
        )
        ...
        self.label_prefix_start_period.setText(
            QCoreApplication.translate("WorkReportsWidget", "\u0441:", None)
        )
        self.label_prefix_end_period.setText(
            QCoreApplication.translate("WorkReportsWidget", "\u043f\u043e:", None)
        )
        ...
        self.pushButton_add_work.setText(
            QCoreApplication.translate(
                "WorkReportsWidget", "\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c", None
            )
        )
        self.pushButton_delete_work.setText(
            QCoreApplication.translate(
                "WorkReportsWidget", "\u0423\u0414\u0410\u041b\u0418\u0422\u042c", None
            )
        )
