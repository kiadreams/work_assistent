...
from ..forms.ui_work_events_report_widget import Ui_WorkEventReportsWidget


class WorkEventReport(QtWidgets.QWidget, Ui_WorkEventReportsWidget, BaseAppWidgetMixin):
