...
class ViewServiceModel(BaseViewModel):
    def __init__(self, company: str):
        ...
        self.__current_service: Service | None = None
    ...
    def add_new_service(self, service_data: tuple[str, str]) -> None:
        ...
        service = Service(name=name, full_name=full_name)
    ...
    def can_delete_current_service(self) -> bool:
    ...
    def change_current_service(self, service_name) -> None:
    ...
    def delete_current_service(self):
