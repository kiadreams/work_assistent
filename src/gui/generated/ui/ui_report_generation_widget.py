...
class Ui_ReportGenerationWidget(object):
    def setupUi(self, ReportGenerationWidget):
        ...
        self.pushButton_divisions = QPushButton(ReportGenerationWidget)
        ...
        self.stackedWidget_report_types = QStackedWidget(ReportGenerationWidget)
        self.stackedWidget_report_types.setObjectName(u"stackedWidget_report_types")
        self.page_0_divisions = QWidget()
        self.page_0_divisions.setObjectName(u"page_0_divisions")
        self.stackedWidget_report_types.addWidget(self.page_0_divisions)
        self.page_1_staff = QWidget()
        self.page_1_staff.setObjectName(u"page_1_staff")
        self.stackedWidget_report_types.addWidget(self.page_1_staff)
        self.page_2_work_types = QWidget()
        self.page_2_work_types.setObjectName(u"page_2_work_types")
        self.stackedWidget_report_types.addWidget(self.page_2_work_types)
        self.page_3_works = QWidget()
        self.page_3_works.setObjectName(u"page_3_works")
        self.stackedWidget_report_types.addWidget(self.page_3_works)
        self.page_4_orders = QWidget()
        self.page_4_orders.setObjectName(u"page_4_orders")
        self.stackedWidget_report_types.addWidget(self.page_4_orders)
        self.page_5_work_events = QWidget()
        self.page_5_work_events.setObjectName(u"page_5_work_events")
        self.stackedWidget_report_types.addWidget(self.page_5_work_events)
        ...
        self.stackedWidget_report_types.setCurrentIndex(2)
    ...
    def retranslateUi(self, ReportGenerationWidget):
        ...
        self.pushButton_divisions.setText(QCoreApplication.translate("ReportGenerationWidget", u"\u043f\u043e\u0434\u0440\u0430\u0437\u0434\u0435\u043b\u0435\u043d\u0438\u044f", None))
